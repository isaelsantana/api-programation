...
import { Programation, ProgramationSchema } from './schemas/programation.schema';

@Module({
  imports: [MongooseModule.forFeature([{ name: Programation.name, schema: ProgramationSchema }])],
